...
//
char*  WINAPI DXGetErrorStringA(__in HRESULT hr);
...
//
char*  WINAPI DXGetErrorDescriptionA(__in HRESULT hr);
...
//
HRESULT WINAPI DXTraceA( __in_z char* strFile, __in DWORD dwLine, __in HRESULT hr, __in_z_opt char* strMsg, __in BOOL bPopMsgBox );
HRESULT WINAPI DXTraceW( __in_z char* strFile, __in DWORD dwLine, __in HRESULT hr, __in_z_opt const WCHAR* strMsg, __in BOOL bPopMsgBox );
